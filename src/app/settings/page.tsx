      ...
      <div className="min-h-screen bg-gray-900 py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              <h1 className="text-3xl font-bold text-white mb-2">Settings Page Under Construction</h1>
              <div className="h-1 w-24 bg-amber-400 mx-auto my-6"></div>
              <p className="text-xl text-gray-300 mb-6">
                We're working hard to build an amazing Settings experience for you.
              </p>
              <p className="text-gray-400 mb-8">
                This page will be available soon with all your Settings management features.
              </p>
